...
public class EquationKeyboard extends Fragment {
    ...
    private LinearLayout keyboardZone3;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        keyboardZone3=root.findViewById(R.id.keyboardzone3);
    ...
    public void addKey(String key){
        ...
        if(keyboardZone.getChildCount()>8){
            if(keyboardZone2.getChildCount()>8)keyboardZone3.addView(keyview);
            else keyboardZone2.addView(keyview);
        }
    ...
    private void moveToKeyboard(View v){
        ...
        if(keyboardZone.getChildCount()>8){
            if(keyboardZone2.getChildCount()>8)keyboardZone3.addView(v);
            else keyboardZone2.addView(v);
        }
